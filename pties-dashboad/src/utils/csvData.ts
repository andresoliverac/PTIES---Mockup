...
export const parseCSV = (csvText: string): Deliverable[] => {
  ...
  return lines.slice(1).map((line, index) => {
    ...
    return {
      ...
      aprobado: (values[10] || 'Pendiente').trim(), // Use actual approval status or default to Pendiente
...
Alistamiento,Revisión documentación previa,Revisión y análisis de documentación institucional previa relacionada con proyectos educativos,Análisis documental,Informe de revisión documental,Entregable adicional,Revisión documentación institucional,5-Aug-25,Universidad Central,X
Alistamiento,Capacitación equipo base,Capacitación inicial del equipo base en metodologías PTIES,Formación inicial,Certificación de capacitación,Entregable adicional,Capacitación metodologías PTIES,10-Aug-25,Universidad Minuto de Dios,X
Alistamiento,Establecimiento cronograma,Definición y establecimiento del cronograma detallado de actividades,Planificación,Cronograma de actividades,Entregable adicional,Cronograma detallado actividades,12-Aug-25,Universidad de los Andes,X
...
1.    Articulación armoniosa,1.2.    Desarrollo de competencias digitales,1.2.1.    Evaluación inicial,Evaluación de competencias digitales básicas,Una evaluación inicial de competencias digitales aplicada a estudiantes beneficiarios PTIES,Tercer entregable,Evaluación competencias digitales básicas,25-Aug-25,Universidad Nacional,
1.    Articulación armoniosa,1.3.    Fortalecimiento académico integral,1.3.1.    Plan de nivelación,Plan de nivelación en ciencias naturales,Diseño e implementación de plan de nivelación en ciencias naturales para estudiantes PTIES,Cuarto entregable,Plan nivelación ciencias naturales,30-Aug-25,Universidad de Antioquia,
2.    Orientación vocacional,2.1.    Exploración de intereses,2.1.1.    Talleres vocacionales,Talleres de exploración vocacional,Realización de talleres para identificar intereses y aptitudes vocacionales de estudiantes,Quinto entregable,Talleres exploración vocacional,5-Sep-25,Universidad del Valle,
2.    Orientación vocacional,2.2.    Información profesional,2.2.1.    Ferias educativas,Organización de ferias educativas,Organización y ejecución de ferias educativas para presentar opciones de educación superior,Sexto entregable,Ferias educativas informativas,10-Sep-25,Universidad Javeriana,
3.    Acompañamiento familiar,3.1.    Escuela de padres,3.1.1.    Formación parental,Talleres de formación para padres,Implementación de talleres formativos dirigidos a padres y acudientes de estudiantes PTIES,Séptimo entregable,Talleres formación padres,15-Sep-25,Universidad Pedagógica Nacional,`;
